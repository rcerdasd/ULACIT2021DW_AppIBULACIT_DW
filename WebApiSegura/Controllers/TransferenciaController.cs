    ...
    public class TransferenciaController : ApiController
    {
        ...
        public IHttpActionResult GetId(int id)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"SELECT SELECT Codigo, CuentaOrigen, CuentaDestino, FechaHora, Descripcion, Monto, Estado FROM Transferencia WHERE Codigo = @Codigo", sqlConnection);
        ...
        public IHttpActionResult GetAll()
        {
            ...
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["INTERNET_BANKING"].ConnectionString))
                {
                    SqlCommand sqlCommand = new SqlCommand(@"SELECT SELECT Codigo, CuentaOrigen, CuentaDestino, FechaHora, Descripcion, Monto, Estado FROM Transferencia", sqlConnection);
                    sqlConnection.Open();
        ...
        public IHttpActionResult Ingresar(Transferencia transferencia)
        {
            ...
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["INTERNET_BANKING"].ConnectionString))
                {
                    SqlCommand sqlCommand = new SqlCommand(@"INSERT INTO Transferencia (CuentaOrigen, CuentaDestino, FechaHora, Descripcion, Monto, Estado) VALUES (@Codigo, @CuentaOrigen, @CuentaDestino, @FechaHora, @Descripcion, @Monto, @Estado)", sqlConnection);
